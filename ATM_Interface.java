...
class transaction{
    ...
    static void transfer(){
        Scanner sc=new Scanner(System.in);
        System.out.println("Enter the receiving entity:");
        String s=sc.nextLine();
        System.out.println("Enter the account number of the receiving entity");
        int num=sc.nextInt();
        System.out.println("Enter the amount to be transferred :");
        int tcash=sc.nextInt();
        if(tcash<=ATM_Interface.balance){
            ATM_Interface.balance=ATM_Interface.balance-tcash;
            ATM_Interface.history.add(Integer.toString(tcash));
            ATM_Interface.history.add("transferred");
            System.out.println("Amount Rs."+tcash+"/- has been transferred successfully");
            System.out.println("*********************");
        }
        else{
            System.out.println("You do not have enough balance to transfer the cash");
            System.out.println("*********************");
        }
    }
}
...
class his{
    static void transactionhistory(){
            ...
            for(int i=0;i<(ATM_Interface.history.size()/2);i++)
            {
                ...
                System.out.println("Your account is having zero balance");
            }
            ATM_Interface.prompt();
    }
}
public class ATM_Interface {
    ...
    static void prompt(){
        Scanner sc=new Scanner(System.in);
        System.out.println("WELCOME "+ATM_Interface.name+"! TO EBL ATM");
        System.out.println("*********************");
        ...
        System.out.print("Enter your destined choice : ");
        int choice=sc.nextInt();
        switch (choice) {
            case 1:
